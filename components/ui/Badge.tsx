...
interface BadgeProps {
  ...
  variant?: "income" | "expense" | "payroll" | "treasury" | "recorded" | "unrecorded" | "default" | "pending" | "failed";
  className?: string;
}
...
export default function Badge({ children, variant = "default", className = "" }: BadgeProps) {
  ...
  const variantStyles = {
    ...
    pending: "bg-gray-100 dark:bg-gray-900/30 text-gray-800 dark:text-gray-400 border border-gray-200 dark:border-gray-800",
    failed: "bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-400 border border-red-200 dark:border-red-800"
  };
